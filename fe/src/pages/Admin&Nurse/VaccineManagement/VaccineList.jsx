            ...
            {vaccines.length === 0 ? (
              <tr>
                <td colSpan="5" className="px-6 py-12 text-center">
                  ...
                  <p className="text-gray-400 text-sm mt-2">Thử thêm vaccine mới</p>
                </td>
              </tr>
            ) : (
              vaccines.map((vaccine) => (
                <tr key={vaccine.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-medium text-gray-900">#{vaccine.id}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-gray-900">{vaccine.name}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-gray-900">{vaccine.description}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-gray-900">{vaccine.disease_name}</span>
                  </td>
