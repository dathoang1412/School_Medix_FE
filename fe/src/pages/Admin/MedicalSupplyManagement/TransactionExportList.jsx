...
const TransactionExportList = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        enqueueSnackbar("Không thể tải danh sách giao dịch xuất.", { variant: "error" });
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      enqueueSnackbar(err.message || "Lỗi khi xóa giao dịch xuất.", { variant: "error" });
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 flex">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex flex-col mb-6">
              <h1 className="text-2xl font-semibold text-gray-900 mb-6">Danh sách giao dịch xuất kho</h1>
                    ...
                    {filteredTransactions.length === 0 ? (
                      <tr>
                        <td colSpan="5" className="px-6 py-12 text-center">
                          ...
                          <p className="text-gray-500 text-lg">Không có giao dịch xuất</p>
        ...
        >
          <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-6 max-w-lg w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-lg font-semibold text-gray-800">Chi tiết giao dịch xuất</h4>
              <button
                onClick={closeModal}
      ...
      <Modal
        ...
        cancelText="Hủy"
      >
        Bạn có chắc muốn xóa giao dịch xuất <strong>{transactionToDelete?.purpose_title || "này"}</strong>? Hành động này không thể hoàn tác.
      </Modal>
    </div>
  );
};
