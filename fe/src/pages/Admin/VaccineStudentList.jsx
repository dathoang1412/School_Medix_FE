...
const VaccineStudentList = () => {
    ...
    const [id] = useState(mockPath.split('/')[4]);
    ...
    const completedStudents = studentList.filter(s => 
        parseInt(s.completed_doses) >= parseInt(s.dose_quantity)
    ).length;
        ...
        <div className="p-6 max-w-6xl mx-auto">
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {studentList.map((student) => {
                                ...
                                const progress = (parseInt(student.completed_doses) / parseInt(student.dose_quantity)) * 100;
                                ...
                                return (
                                    <tr key={student.student_id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${vaccinationInfo.bgColor} ${vaccinationInfo.textColor}`}>
            ...
            {studentList.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">Không có học sinh nào đủ điều kiện tiêm chủng</p>
                </div>
            )}
        </div>
    );
