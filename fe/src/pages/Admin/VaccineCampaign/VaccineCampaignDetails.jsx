    ...
    <div className="w-full mx-auto p-10 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-lg">
              Thông tin chi tiết về chiến dịch #{details.campaign_id}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Campaign Overview */}
          <div
            className={`bg-white rounded-xl shadow-lg border-l-4 ${getCardBorderColor(
              details.status
            )} p-8`}
          >
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <div
                  className={`inline-flex items-center space-x-2 px-4 py-2 rounded-lg border font-semibold ${getStatusColor(
                    details.status
                  )}`}
                >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-blue-800">
                      {calculateDuration(details.start_date, details.end_date)}{" "}
                      ngày
                    </p>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <button
                onClick={() => {
                  navigate("/admin/vaccine-campaign/student-list/" + id);
                }}
