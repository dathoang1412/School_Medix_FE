...
const SetupPassword = () => {
  ...
  useEffect(() => {
    ...
    if (access_token) {
      ...
      enqueueSnackbar("Missing token from invite link.", { variant: "error" });
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      enqueueSnackbar("Failed to set password: " + error.message, { variant: "error" });
    } else {
      enqueueSnackbar("Password set successfully. Please login.", { variant: "success" });
      navigate("/login");
    }
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Complete your registration by setting a password</p>
        </div>
