                      ...
                      {[
                        ...
                        <div key={label} className="flex items-start">
                          ...
                          <textarea
                            ...
                            className="flex-1 text-sm text-gray-800 border border-gray-200 rounded-lg p-2 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                            rows="4"
                            placeholder="Nhập chẩn đoán y tế"
                          />
                        </div>
                      ))}
                    </div>
